...
import com.express.flowers.flowersexpress.Activity.LoginActivity;
import com.express.flowers.flowersexpress.Activity.OrderList;
...
public class MyFragment extends android.support.v4.app.Fragment implements View.OnClickListener{
    ...
    private void startAccountManager() {
        Intent i = new Intent(getActivity(), com.express.flowers.flowersexpress.Activity.AccountManager.class);
